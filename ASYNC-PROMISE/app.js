...
const container = document.getElementById("contenido-usuarios");
...
function getUsers(callback){
    ...
    setTimeout(()=>{
        const users = [
    { id: 1, name : "Oscar", years : 20},
    { id: 2, name : "Eber", years : 19 }
    ];
...
function getUserInfo(id, callback){
    ...
    setTimeout(()=>{
        const userInfo = [
            { id: 1, idUser: 2, fullName: "Eber Horacio", birthday: "2003-10-17"},
            { id: 2, idUser: 1, fullName: "Oscar Hernandez", birthday: "2007-09-03"}
        ];
